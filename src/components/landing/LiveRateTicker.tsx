...
export function LiveRateTicker() {
  ...
  return (
    <div className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-800/80 px-3 py-1 text-[11px] font-semibold text-slate-600 dark:text-slate-300">
