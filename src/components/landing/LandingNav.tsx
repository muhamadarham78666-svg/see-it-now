  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        scrolled
          ? 'glass shadow-sm py-2.5 sm:pt-3 sm:pb-11'
          : 'bg-transparent py-3 sm:pt-5 sm:pb-11'
      }`}
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        <div className="relative flex min-w-0 flex-col items-start gap-2 sm:flex-row sm:items-center sm:gap-0">
          <Logo size="sm" />
          <div className="shrink-0 sm:absolute sm:left-0 sm:top-full sm:mt-3.5">
            <LiveRateTicker />
          </div>
        </div>
