...
const features = [
  ...
  { icon: PencilLine, title: 'Special Instructions', desc: 'Write any requirement in your own words — the paper follows it exactly.' },
  { icon: Newspaper, title: 'Board Paper Pattern', desc: 'Section-wise numbering, marks and “attempt any” choices like real boards.' },
  { icon: Languages, title: 'Full Urdu Papers', desc: 'Tashreeh, khulasa, markazi khayal, khat, kahani and mazmoon in Urdu script.' },
  { icon: Globe, title: 'Translation Questions', desc: 'Urdu → English and English → Urdu translation items for English papers.' },
  { icon: ScanSearch, title: 'Diagrams & Figures', desc: 'Clean figures added automatically wherever they help the question.' },
