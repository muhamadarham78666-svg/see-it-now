...
- Question Bank bulk fill aur single-chapter bank fill isi mode mein sirf `zain`, `zain2`, `zain3` use karein ge.
- Teenon free keys unavailable hon to Lovable AI call bilkul nahi hogi; is flow se paid credit zero kharch hoga.
