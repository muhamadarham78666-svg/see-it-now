...
## 1. Question Papers feature should bi removed
...
- Notes prompt is rewritten to build notes strictly from the uploaded material or the chosen book/chapter — no outside sources, no invented extra content. Puri book upload honi chahye or book read bi honi chahye aoi se mny puri book upload ki thi but ni hoi chahy wo jesy bi ho result zaror ana chahye or accurate ana chahye
